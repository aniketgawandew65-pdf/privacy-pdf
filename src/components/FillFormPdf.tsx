          ...
          {!downloadUrl ? (
            ...
            <div className="space-y-3">
              ...
              <button
                ...
                className="w-full py-3 px-4 border border-[#3f3f46] bg-[#3f3f46] hover:bg-[#27272a] text-white font-semibold rounded-xl flex items-center justify-center gap-2 transition-all"
              >
