...
export const UnlockPdf: React.FC<UnlockPdfProps> = ({ file, onFileChange }) => {
      ...
      {!file ? (
        ...
        <div className="space-y-5 text-left">
          ...
          <div className="space-y-1.5">
            <label className="text-xs font-medium text-zinc-400">Enter PDF Password</label>
          ...
          {!downloadUrl ? (
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2 text-xs text-emerald-400 bg-emerald-950/30 p-3 rounded-lg border border-emerald-800/30 font-medium">
                ...
                <span>Password protection permanently removed!</span>
              </div>
              <a
                href={downloadUrl}
