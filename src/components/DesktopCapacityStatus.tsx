...
export function DesktopCapacityStatus({
  ...
  return (
    ...
    >
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            <p className="m-0 text-xs font-semibold text-zinc-900">
              Desktop capacity
            </p>
        ...
        <>
          <div className="mt-4 grid grid-cols-2 gap-3">
            <div className="rounded-lg border border-zinc-300 bg-white px-3 py-2.5">
              <span className="block text-[10px] font-medium uppercase tracking-wide text-zinc-600">
                Selected
              </span>

              <strong className="mt-1 block text-sm font-semibold text-zinc-900">
                {selectedLabel}
              </strong>
            </div>
          ...
          <p
            className="mt-3 mb-0 flex items-start gap-2 text-xs leading-5 text-zinc-700"
            role={
              signal === 'red'
                ? 'alert'
                : 'status'
      ...
      <p className="mt-3 mb-0 text-[10px] leading-4 text-zinc-600">
