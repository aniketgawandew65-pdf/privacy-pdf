...
const TOOLS_LIST: NavTool[] = [
  ...
  { name: 'Crop PDF', path: '/crop-pdf', category: 'organize', icon: Crop },
  { name: 'Rotate PDF', path: '/rotate-pdf', category: 'organize', icon: RotateCw },
  { name: 'Remove Pages', path: '/remove-pages', category: 'organize', icon: Trash2 },
  { name: 'Resize PDF', path: '/resize-pdf', category: 'organize', icon: Scaling },
  { name: 'Multiple Pages per Sheet', path: '/nup-pdf', category: 'organize', icon: Columns2 },
  { name: 'Booklet PDF', path: '/booklet-pdf', category: 'organize', icon: BookOpen },
  { name: 'Straighten PDF', path: '/deskew-pdf', category: 'organize', icon: RotateCw },

  { name: 'Sanitize PDF', path: '/sanitize-pdf', category: 'security', icon: EyeOff },
  { name: 'Auto Redact PDF', path: '/private-pii-secrets-auto-redactor', category: 'security', icon: ShieldCheck },
  { name: 'Redact PDF', path: '/redact-pdf', category: 'security', icon: SquareSlash },
  { name: 'Protect PDF', path: '/protect-pdf', category: 'security', icon: Lock },
  { name: 'Unlock PDF', path: '/unlock-pdf', category: 'security', icon: Unlock },
  { name: 'Sign PDF', path: '/sign-pdf', category: 'security', icon: PenTool },
  { name: 'Watermark PDF', path: '/watermark-pdf', category: 'security', icon: Stamp },
  { name: 'Bates Numbering', path: '/bates-numbering', category: 'security', icon: FileDigit },
  { name: 'Compare PDF', path: '/compare-pdf', category: 'security', icon: GitCompare },
  ...
  { name: 'AI Summarizer', path: '/ai-summary-pdf', category: 'convert', icon: Bot },
  { name: 'OCR PDF', path: '/ocr-pdf', category: 'convert', icon: ScanText },
{ name: 'PDF Forms', path: '/fill-pdf', category: 'convert', icon: FileCheck2 },
  ...
  { name: 'B&W / Grayscale PDF', path: '/grayscale-pdf', category: 'convert', icon: Printer },
  ...
  { name: 'Image to PDF & other formats', path: '/image-converter', category: 'convert', icon: ImageIcon },
  ...
  { name: 'HTML to PDF', path: '/html-to-pdf', category: 'convert', icon: Receipt },
];
        ...
        >
          ...
          <ErrorBoundary key={location.pathname}>
            ...
            <Routes>
              ...
              <Route path="/compress-pdf-to-300kb" element={<Compressor file={activeFile} onFileChange={handleSingleFileChange} />} />
              <Route path="/compress-pdf-to-500kb" element={<Compressor file={activeFile} onFileChange={handleSingleFileChange} />} />
              <Route path="/compress-pdf-to-1mb" element={<Compressor file={activeFile} onFileChange={handleSingleFileChange} />} />
              <Route path="/compress-pdf-to-2mb" element={<Compressor file={activeFile} onFileChange={handleSingleFileChange} />} />
