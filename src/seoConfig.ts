...
export const TOOLS_METADATA: Record<string, ToolMeta> = {
  ...
  '/compress-pdf': {
    ...
    description: 'Compress PDF documents client-side without uploading to any server. Adjust file size and quality without a server upload.',
  ...
  '/compress-pdf-to-100kb': {
    ...
    title: 'Compress PDF to 100KB Online — Private PDF Tool',
  ...
  "/edit-pdf": {"path": "/edit-pdf", "title": "Edit your PDF | 1into1 PDF", "description": "Add text, images and shapes to a PDF without uploading it.", "heading": "Edit your PDF", "subheading": "Add text, images and shapes to a PDF without uploading it."},
  "/visual-editor": {"path": "/visual-editor", "title": "Edit your PDF | 1into1 PDF", "description": "Add text, images and shapes to a PDF without uploading it.", "heading": "Edit your PDF", "subheading": "Add text, images and shapes to a PDF without uploading it."},
