...
export const TOOLS_METADATA: Record<string, ToolMeta> = {
  ...
  '/pdf-to-markdown': {
    ...
    description: 'Convert PDF text into clean Markdown for notes, documentation, ChatGPT and other LLM workflows. Extraction runs locally in your browser.',
    heading: 'PDF to Markdown Converter',
    subheading: 'Convert PDF content into structured Markdown for AI, LLM and documentation workflows.',
  },
  '/bank-statement-to-excel': {
    path: '/bank-statement-to-excel',
    title: 'Bank Statement PDF to Excel Converter — Private | 1into1',
    description: 'Convert bank statement PDF tables into Excel-ready or CSV data in your browser. Review transactions and balances against the original statement.',
  ...
  '/extract-pdf-for-llm': {
    ...
    title: 'PDF to Markdown for ChatGPT & LLMs — Private | 1into1',
    description: 'Extract PDF content into structured Markdown for ChatGPT, Claude, Ollama and other LLM workflows. Extract locally, then choose what you share.',
    heading: 'Convert PDF to Markdown for LLMs',
    subheading: 'Prepare clean PDF text for ChatGPT, Claude, Ollama and other AI workflows before sharing it with a model.',
  },
